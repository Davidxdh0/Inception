...
if [ ! -f /var/www/wordpress/wp-config.php ]; then
	...
	wp core install --allow-root --url=$WP_URL --title="dyeboa.42.fr" --admin_user=$WORDPRESS_DB_USER --admin_password=$WP_PWD1 --admin_email=user1@42.fr
	...
	sed -i 's|listen = /run/php/php8.2-fpm.sock|listen = 0.0.0.0:9000|g' /etc/php/7.3/fpm/pool.d/www.conf
